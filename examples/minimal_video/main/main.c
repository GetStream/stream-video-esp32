/**
 * @file main.c
 * @brief Minimal video example - Audio + video publishing
 */
...
static const char *TAG = "minimal_video_example";

void app_main(void)
{
    ESP_LOGI(TAG, "Stream Video ESP32 - Minimal Video Example");
    ...
    // TODO: Add example code for connecting to a room and publishing audio + video
